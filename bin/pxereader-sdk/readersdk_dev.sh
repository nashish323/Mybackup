...
#		ssh  $hostname "sudo mkdir $TOMCAT_PATH/webapps/readersdk/hyphenator/; sudo chown -R ubuntu:ubuntu $TOMCAT_PATH/webapps/readersdk/hyphenator"
 #               ssh  $hostname "sudo mkdir $TOMCAT_PATH/webapps/readersdk/hyphenator/$CURRENT_VERSION; sudo chown -R ubuntu:ubuntu $TOMCAT_PATH/webapps/readersdk/hyphenator/ "
